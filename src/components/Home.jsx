    ...
    <section id="home" className="relative w-full min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-white flex items-center justify-center transition-colors duration-500">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        >
          ...
          <motion.h1
            className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl font-bold mb-6 sm:mb-8 leading-tight"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          <motion.p
            className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-600 dark:text-gray-300 max-w-4xl mx-auto mb-6 sm:mb-8 px-4"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            <div className="flex items-center gap-3 sm:gap-4">
              <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-full overflow-hidden border-4 border-blue-500/20 dark:border-blue-400/20">
                <img 
                  src="/profile.jpg" 
                  alt="Shahzaib Ali" 
              ...
              <div className="text-left">
                <h3 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-white">Shahzaib Ali</h3>
                <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Web Developer & Full Stack Engineer</p>
              </div>
            </div>
          ...
          >
            <motion.button
              className="relative overflow-hidden px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-full font-bold shadow-xl group text-sm sm:text-base"
              whileHover={{ 
                scale: 1.05,
            ...
            <motion.button
              ...
              className={`px-6 sm:px-8 py-3 sm:py-4 bg-transparent border-2 border-gray-300 dark:border-white/30 hover:border-gray-400 dark:hover:border-white/50 text-gray-700 dark:text-white rounded-full font-bold backdrop-blur-sm transition-all group text-sm sm:text-base ${
          ...
          >
            {['Web Development', 'Mobile Apps', 'Full Stack', 'SEO', 'React', 'Node.js', 'Next.js', 'MongoDB'].map((skill, index) => (
              <motion.span
                key={skill}
                className="px-3 sm:px-4 py-1.5 sm:py-2 bg-gray-100/80 dark:bg-gray-800/80 text-gray-700 dark:text-gray-300 rounded-full text-xs sm:text-sm font-medium backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50"
        ...
        {/* Floating Features */}
        <motion.div
          className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 mt-12 sm:mt-16 px-4"
          initial={{ opacity: 0, y: 50 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          {features.map((feature, index) => (
            ...
            >
              <div className="bg-white/90 dark:bg-gray-900/90 backdrop-blur-sm p-4 sm:p-6 rounded-2xl h-full border border-gray-200/50 dark:border-gray-700/50">
                <div className="text-3xl sm:text-4xl mb-3 sm:mb-4">{feature.icon}</div>
                <h3 className="text-lg sm:text-2xl font-bold mb-2 text-gray-900 dark:text-white">{feature.title}</h3>
